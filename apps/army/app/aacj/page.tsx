...
export default function AacjPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      <PageIntro label="Military justice" title="Code of Justice">
        <p>
          The AACJ defines offenses, investigations, tribunals, sanctions, and appeals. It enforces
          the{" "}
          <NavLink href="/aac" className="text-crimson transition-colors hover:text-bleach">
            AWFixer Army Code
          </NavLink>
          . Every soldier is subject to it.
        </p>
      </PageIntro>
