      ...
      <section className="border-b border-glass-border px-6 py-20 lg:py-28">
        <div className="mx-auto max-w-[1200px]">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            AWFixer LLC provides management, administration, and oversight across AWFixer&apos;s Church
            and the organizations and businesses it owns. This is the operating map — not an
