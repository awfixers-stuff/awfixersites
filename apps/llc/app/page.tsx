...
export default function Page() {
  return (
    <div className="flex flex-col">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1200px] flex-col gap-12">
          ...
          <Reveal immediate delay={0.16}>
            <p className="max-w-2xl text-lg leading-relaxed text-muted-foreground lg:text-xl">
              AWFixer LLC is the management, administration, and oversight division of AWFixer&apos;s
              Church and church-owned organizations and businesses. We run the backbone — so the
              work in front of the world stays sharp.
            </p>
          </Reveal>
            ...
            <div className="grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-glass-border bg-glass-border sm:grid-cols-4">
              {metrics.map((m) => (
                ...
                >
                  ...
                  <span className="font-display text-sm text-off-white sm:text-base">{m.value}</span>
                </div>
              ))}
            </div>
          </Reveal>
      ...
      <section id="mandate" className="section-auto border-t border-glass-border px-6 py-24 lg:py-32">
          ...
          <Reveal delay={0.08}>
            <div className="space-y-6 text-base leading-relaxed text-muted-foreground">
              <p>
                ...
                exists to steward legal entities, operational cadence, and executive visibility across
                the Church and the businesses it owns.
              </p>
              <p>
      ...
      <section id="contact" className="section-auto border-t border-glass-border px-6 py-24 lg:py-32">
